...
Revision ID: d154ec55a2c2
Revises:
Create Date: 2025-04-10 11:32:32.915172
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_aicaches_user_id_users"),
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_aicaches")),
    )
    op.create_index(
        op.f("ix_aicaches_cache_key"), "aicaches", ["cache_key"], unique=True
    )
    op.create_index(
        op.f("ix_aicaches_destination"),
        "aicaches",
        ["destination"],
        unique=False,
    )
    op.create_index(op.f("ix_aicaches_id"), "aicaches", ["id"], unique=False)
    op.create_index(op.f("ix_aicaches_origin"), "aicaches", ["origin"], unique=False)
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["ai_cache_id"],
            ["aicaches.id"],
            name=op.f("fk_routes_ai_cache_id_aicaches"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["last_edited_by"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["route_id"],
            ["routes.id"],
            name=op.f("fk_routedays_route_id_routes"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_routedays")),
    )
    op.create_index(op.f("ix_routedays_id"), "routedays", ["id"], unique=False)
    op.create_table(
        "activities",
        ...
        sa.ForeignKeyConstraint(
            ["day_id"],
            ["routedays.id"],
            name=op.f("fk_activities_day_id_routedays"),
            ondelete="CASCADE",
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_routedays_id"), table_name="routedays")
    op.drop_table("routedays")
    ...
    op.drop_index("ix_cache_from_to_days_budget", table_name="aicaches")
    op.drop_index(op.f("ix_aicaches_origin"), table_name="aicaches")
    op.drop_index(op.f("ix_aicaches_id"), table_name="aicaches")
    op.drop_index(op.f("ix_aicaches_destination"), table_name="aicaches")
    op.drop_index(op.f("ix_aicaches_cache_key"), table_name="aicaches")
    op.drop_table("aicaches")
    op.drop_index(op.f("ix_users_username"), table_name="users")
    op.drop_index(op.f("ix_users_telegram_id"), table_name="users")
    op.drop_index(op.f("ix_users_id"), table_name="users")
    op.drop_table("users")

    # Explicitly drop the ENUM types
