...
Revision ID: 11f350b6607d
Revises:
Create Date: 2025-04-13 07:56:38.682415
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_ai_cache_budget"), "ai_cache", ["budget"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_ai_cache_origin"), "ai_cache", ["origin"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_route_access_id"), "route_access", ["id"], unique=False
    )
    op.create_table(
        "route_days",
        sa.Column("route_id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_route_days_id"), "route_days", ["id"], unique=False
    )
    op.create_table(
        "activities",
    ...
    op.create_index(
        op.f("ix_activities_id"), "activities", ["id"], unique=False
    )
